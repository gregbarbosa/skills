...
If the project you are in ships its own teardown of that reference, read it;
otherwise skip it, do not search — the skill is self-contained without it.
